                ...
                >
                  <td style={{ ...tdStyle, textAlign: 'left' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: compact ? '0.4rem' : '0.8rem' }}>
                      ...
                      <div>
                        <div style={{ fontWeight: 'bold', fontSize: compact ? '0.75rem' : '1rem', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: compact ? '80px' : '150px' }}>{p.persona || 'Anonymous'}</div>
                  ...
                  <td style={tdStyle}>
                    <div style={{ display: 'flex', gap: compact ? '0.1rem' : '0.2rem', alignItems: 'center', justifyContent: 'center' }}>
                      {/* Active Items */}
